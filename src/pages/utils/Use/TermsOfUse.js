  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="p-6">
        ...
        <br></br>
        <p>
          Kindly note that to partake in our services, a minimum age requirement
          of 13 years is stipulated. Furthermore, it is incumbent upon you to
          diligently safeguard the confidentiality of your account credentials,
          including your password, understanding the pivotal role they play in
          securing your engagement.
        </p>
        <br></br>
        <p>
        ...
        <p>
          ...
          need may arise, to conclude their provision entirely. This prerogative
          is exercised judiciously, with the objective of advancing the overall
          quality and scope of our offerings.
        </p>
        <br></br>
        <p>
          ...
          Creative Minds Graphics (Pty) Ltd. As we embark on this collaborative
          journey, let these terms underscore the commitment we collectively
          exhibit toward nurturing a secure, ethical, and productive digital
          environment.
        </p>
      </div>
    </div>
